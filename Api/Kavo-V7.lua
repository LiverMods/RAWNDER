-- // Kavo Ui V6 (Ultra Premium Mobile Edit 2026) \\ --
...
local themeStyles = {
    ...
    Private = { SchemeColor = Color3.fromRGB(255, 212,0), Background = Color3.fromRGB(0, 0, 0), Header = Color3.fromRGB(31, 31, 31), TextColor = Color3.fromRGB(255,255,255), ElementColor = Color3.fromRGB(255, 212,0) },
    Luna = { SchemeColor = Color3.fromRGB(126, 6, 232), Background = Color3.fromRGB(0, 0, 0), Header = Color3.fromRGB(31, 31, 31), TextColor = Color3.fromRGB(255,255,255), ElementColor = Color3.fromRGB(31, 31, 31) },
    ...
    DarkBlue = { SchemeColor = Color3.fromRGB(27, 27, 227), Background = Color3.fromRGB(10, 10, 10), Header = Color3.fromRGB(5, 5, 5), TextColor = Color3.fromRGB(255,255,255), ElementColor = Color3.fromRGB(20, 20, 20) },
...
function Kavo.CreateLib(kavName, themeList)
    ...
    elseif themeList == "DarkBlue" then themeList = themeStyles.DarkBlue
    elseif themeList == "Luna" then themeList = themeStyles.Luna
    ...
    -- ==========================================
    -- NOVO: BOTÃO MOBILE FLUTUANTE 
    -- ==========================================
    local MobileToggle = Instance.new("ImageButton")
    MobileToggle.Name = "MobileToggle"
    MobileToggle.Parent = ScreenGui
    MobileToggle.BackgroundColor3 = themeList.Header
    ...
    MobileToggle.ImageRectOffset = Vector2.new(804, 44)
    MobileToggle.ImageRectSize = Vector2.new(36, 36)
    MobileToggle.ImageColor3 = themeList.SchemeColor
    ...
    MobileStroke.Color = themeList.SchemeColor
    MobileStroke.Thickness = 1.5
    MobileStroke.Parent = MobileToggle
    
    Kavo:DraggingEnabled(MobileToggle, MobileToggle)

    -- ==========================================
    -- JANELA PRINCIPAL (Glassmorphism)
    -- ==========================================
    ...
    BorderGradient.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, themeList.SchemeColor),
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 255, 255)),
        ColorSequenceKeypoint.new(1.00, themeList.SchemeColor)
    })
    ...
    MainHeader.BackgroundTransparency = 0.15
    ...
    coverup.BackgroundTransparency = 0.15
    ...
    MainSide.BackgroundTransparency = 0.15
    ...
    coverup_2.BackgroundTransparency = 0.15
    ...
    function Kavo:IsFinalizing()
        local kavo = game:GetService("CoreGui"):FindFirstChild(kavName)
        if kavo then
            pcall(function() encryptNames(kavo) end)
        end
    end
    
    -- ANIMAÇÃO DE TOGGLE UX
    local isUiOpen = true
    function Kavo:ToggleUI()
        if isUiOpen then
            isUiOpen = false
            tween:Create(MainScale, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.In), {Scale = 0}):Play()
            tween:Create(Main, TweenInfo.new(0.3), {BackgroundTransparency = 1}):Play()
        else
            isUiOpen = true
            Main.BackgroundTransparency = 0.15
            tween:Create(MainScale, TweenInfo.new(0.5, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Scale = 1}):Play()
        end
    end
    ...
    function Tabs:NewTab(tabName)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            Utility:TweenObject(tabButton, {BackgroundTransparency = 0.2}, 0.2)
        end)
        local Sections = {}
        ...
        function Sections:NewSection(secName, hidden)
            ...
            sectionHead.BackgroundTransparency = 0.1
            ...
            function Elements:NewButton(bname, tipINf, callback)
                ...
                tipINf = tipINf or "without description"
                ...
                buttonElement.BackgroundTransparency = 0.3
                ...
                btn.MouseEnter:Connect(function()
                    if not focusing then
                        tween:Create(btn, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
            ...
            function Elements:NewTextBox(tname, tTip, tBox, callback)
                tname = tname or "Textbox"
                tTip = tTip or "Get a value of Textbox"
            
                if typeof(tBox) == "function" then
                    callback = tBox
                    tBox = "Type here!"
                else
                    tBox = tBox or "Type here!"
                end
                ...
                function Elements:NewToggle(tname, nTip, callback)
                    ...
                    toggleElement.BackgroundTransparency = 0.3
                    ...
                    btn.MouseButton1Click:Connect(function()
                        if not focusing then
                            if toggled == false then
                                tween:Create(img, TweenInfo.new(0.11, Enum.EasingStyle.Linear,Enum.EasingDirection.In), {
                                    ImageTransparency = 0
                                }):Play()
                                local c = sample:Clone()
                                c.Parent = btn
            ...
            function Elements:NewSlider(slidInf, slidTip, maxvalue, minvalue, callback)
                ...
                sliderElement.BackgroundTransparency = 0.3
                ...
                sliderBtn.MouseButton1Down:Connect(function()
                    if not focusing then
                        tween:Create(val, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                            TextTransparency = 0
                        }):Play()
            ...
            function Elements:NewDropdown(dropname, dropinf, list, clickName, callback)
                local DropFunction = {}
                ...
                dropOpen.BackgroundTransparency = 0.3
                ...
                for i,v in next, list do
                    ...
                    optionSelect.MouseEnter:Connect(function()
                        if not focusing then
                            tween:Create(optionSelect, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                                BackgroundColor3 = Color3.fromRGB(themeList.ElementColor.r * 255 + 8, themeList.ElementColor.g * 255 + 9, themeList.ElementColor.b * 255 + 10)
                            }):Play()
                            oHover = true
                        end 
            ...
            function Elements:NewKeybind(keytext, keyinf, first, callback)
                ...
                keybindElement.BackgroundTransparency = 0.3
                ...
                keybindElement.MouseEnter:Connect(function()
                    if not focusing then
                        tween:Create(keybindElement, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                            BackgroundColor3 = Color3.fromRGB(themeList.ElementColor.r * 255 + 8, themeList.ElementColor.g * 255 + 9, themeList.ElementColor.b * 255 + 10)
                        }):Play()
                        oHover = true
                    end 
            ...
            function Elements:NewColorPicker(colText, colInf, defcolor, callback)
                ...
                colorHeader.BackgroundTransparency = 0.3
                ...
                colorElement.MouseEnter:Connect(function()
                    if not focusing then
                        tween:Create(colorElement, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                            BackgroundColor3 = Color3.fromRGB(themeList.ElementColor.r * 255 + 8, themeList.ElementColor.g * 255 + 9, themeList.ElementColor.b * 255 + 10)
                        }):Play()
                        hovering = true
                    end 
                ...
                local function togglerainbow()
                    if rainbow then
                        tween:Create(toggleEnabled, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            ImageTransparency = 1
                        }):Play()
                        rainbow = false
